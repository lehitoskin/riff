...
(define/dec flif-create-decoder (_fun -> _FLIF-DECODER)
...
(define/dec flif-destroy-decoder (_fun [decoder : _FLIF-DECODER] -> _void)
  #:c-id flif_destroy_decoder)

; abort a decoder (may be used before decoding is completed)
(define/dec flif-abort-decoder (_fun [decoder : _FLIF-DECODER] -> _int32)
...
(define/dec flif-destroy-info (_fun [info : _FLIF-INFO] -> _void)
  #:c-id flif_destroy_info)

; get the image width
(define/dec flif-info-get-width (_fun [info : _FLIF-INFO] -> _uint8)
  #:c-id flif_info_get_width)

; get the image height
(define/dec flif-info-get-height (_fun [info : _FLIF-INFO] -> _uint8)
  #:c-id flif_info_get_height)

; get the number of color channels
(define/dec flif-info-get-nb-channels (_fun [info : _FLIF-INFO] -> _uint8)
  #:c-id flif_info_get_nb_channels)

; get the number of bits per channel
(define/dec flif-info-get-depth (_fun [info : _FLIF-INFO] -> _uint8)
  #:c-id flif_info_get_depth)

; get the number of animation frames
(define/dec flif-info-num-images (_fun [info : _FLIF-INFO] -> _size)
