...
@deftogether[(@defproc[(flif-create-image [width integer?] [height integer?]) _FLIF-IMAGE]
              ...
              @defproc[(flif-create-image-gray16 [width integer?] [height integer?]) _FLIF-IMAGE]
...
@deftogether[(@defproc[(flif-import-image-rgba! [width integer?]
              ...
              @defproc[(flif-import-image-gray! [width integer?]
                                                ...
                                                [gray bytes?]
                                                [stride integer?]) _FLIF-IMAGE]
              @defproc[(flif-import-image-gray16! [width integer?]
                                                  [height integer?]
                                                  [gray bytes?]
                                                  [stride integer?]) _FLIF-IMAGE]
...
@deftogether[(@defproc[(flif-image-write-row-rgba16! [image _FLIF-IMAGE]
              ...
              @defproc[(flif-image-read-rgba16 [image _FLIF-IMAGE]
                                               [width integer?]
                                               [height integer?]) bytes?]
              @defproc[(flif-image-write-row-gray16! [image _FLIF-IMAGE]
                                                     [row integer?]
                                                     [buffer cpointer?]) void?]
              @defproc[(flif-image-read-row-gray16! [image _FLIF-IMAGE]
                                                    [row integer?]
                                                    [buffer cpointer?]
                                                    [len integer?]) void?]
              @defproc[(flif-image-read-gray16 [image _FLIF-IMAGE]
                                               [width integer?]
                                               [height integer?]) bytes?])]{
